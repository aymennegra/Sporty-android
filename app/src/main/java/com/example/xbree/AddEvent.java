...
public class AddEvent extends AppCompatActivity implements View.OnClickListener {
    ...
    EditText nom, distance, lieu, prix, contact, datedebut, datefin, camp_desc, nbPlace;
    Button add;
            ...
            public void onClick(View v) {
                ...
                acceptButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        addEvenement(nom.getText().toString(), type.getSelectedItem().toString(), datedebut.getText().toString(), datefin.getText().toString(), 0,
                ...
                cancelButton.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        addEvenement(nom.getText().toString(), type.getSelectedItem().toString(), datedebut.getText().toString(), datefin.getText().toString(), Integer.parseInt(distance.getText().toString()),
                                lieu.getText().toString(), Integer.parseInt(contact.getText().toString()), Integer.parseInt(prix.getText().toString()), camp_desc.getText().toString(), Integer.parseInt(nbPlace.getText().toString()), idus);
