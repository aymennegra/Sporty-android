...
public class Accueil extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void Most_viewedRecycler() {
        ...
        featuredLocations.add(new Most_viewedHelperClass(R.drawable.stade1, "Stade ariana"));
        featuredLocations.add(new Most_viewedHelperClass(R.drawable.stade2, "Stade el menzah"));
        featuredLocations.add(new Most_viewedHelperClass(R.drawable.stade3, "Stade Raoued"));
    ...
    private void CategoriesRecycler() {
        ...
        categoriesLocations.add(new CategoriesHelperClass(R.drawable.footb, "Football"));
        categoriesLocations.add(new CategoriesHelperClass(R.drawable.basket, "BasketBall"));
        categoriesLocations.add(new CategoriesHelperClass(R.drawable.tennis, "Tennis"));
        categoriesLocations.add(new CategoriesHelperClass(R.drawable.volley, "VolleyBall"));
        categoriesLocations.add(new CategoriesHelperClass(R.drawable.pingpong, "Ping pong"));
    ...
    private void FeaturedRecycler() {
        ...
        featuredLocations.add(new FeaturedHelperClass(R.drawable.stade1, "Stade ariana"));
        featuredLocations.add(new FeaturedHelperClass(R.drawable.stade2, "Stade el menzah"));
        featuredLocations.add(new FeaturedHelperClass(R.drawable.stade3, "Stade Raoued"));
